            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">Menu Templates</h3>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($menus as $menu)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $menu->created_at->format('M d, Y') }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">No menus found. Create one to get started!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
